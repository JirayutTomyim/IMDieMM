<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/DieMasterPage/DieMaster.Master" CodeBehind="partHistory.aspx.vb" Inherits="DieMaintenance.partHistory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
                 <h1 style="margin-left:25%;;color:white">Spare part History</h1>
        </div>
    <table style="margin-left:17%; width:50%;font-size:90%;">
        <tr>
            <td >Die No. :</td>
    ...
    <div style="overflow: auto;width:90%;margin-left:5%;height:60vh;">
        <asp:GridView ID="grdSpareHis" runat="server" class="customers" ></asp:GridView>
